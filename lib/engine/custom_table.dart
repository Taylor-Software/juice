...
/// The `source` stamped on the bundled starter-pack tables
/// (assets/starter_tables.json, generated by build_starter_tables.py) — the
/// Tables screen hides its import affordance once any table carries it.
const kStarterTableSource = 'Starter set';
